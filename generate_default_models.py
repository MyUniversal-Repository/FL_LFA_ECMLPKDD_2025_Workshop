...
from federated_learning.nets import FEMNISTCNN
...
if __name__ == '__main__':
    ...
    # # -------- FEMNISTCNN --------
    # # ---------------------------------
    # full_save_path = os.path.join(args.get_default_model_folder_path(), "FEMNISTCNN.model")
    # torch.save(FEMNISTCNN().state_dict(), full_save_path)