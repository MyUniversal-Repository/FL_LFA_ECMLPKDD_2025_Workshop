...
#         # Save model at the start of epoch
#         if self.args.should_save_model(epoch):
#             self.save_model(epoch, self.args.get_epoch_save_start_suffix())
...
#             # Reshape the input to the correct shape for the convolutional network
#             inputs = inputs.view(inputs.size(0), 1, 28, 28)  # Reshaping to [batch_size, 1, 28, 28]
...
#                 # Reshape the input to the correct shape for the convolutional network
#                 images = images.view(images.size(0), 1, 28, 28)  # Reshaping to [batch_size, 1, 28, 28]
...
##  WORKING FEMNIST DATASET IT IS WORKING#######################################################
...
#             # Cast labels to Long type
#             labels = labels.long()  # Add this line
