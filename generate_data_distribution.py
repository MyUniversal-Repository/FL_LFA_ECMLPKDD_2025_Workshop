...
######## THE FOLLOWING CODE WORKS FOR FEMNIST EXPERIMNET ##########################################
...
# from federated_learning.datasets import CIFAR10Dataset
# from federated_learning.datasets import FashionMNISTDataset
# from federated_learning.datasets import FEMNISTDataset
# from federated_learning.utils import generate_train_loader
# from federated_learning.utils import generate_test_loader
# from federated_learning.utils import save_data_loader_to_file
...
#     # dataset = FEMNISTDataset(args)
#     # #dataset = FEMNISTDataset
#     # # TRAIN_DATA_LOADER_FILE_PATH = "data_loaders/fashion-mnist/train_data_loader.pickle"
#     # # TEST_DATA_LOADER_FILE_PATH = "data_loaders/fashion-mnist/test_data_loader.pickle"

#     # # TRAIN_DATA_LOADER_FILE_PATH = "data_loaders/femnist/femnist_train.pickle"
#     # # TEST_DATA_LOADER_FILE_PATH = "data_loaders/femnist/femnist_test.pickle"
#     # TRAIN_DATA_LOADER_FILE_PATH = "data_loaders/femnist/train_data_loader.pickle"
#     # TEST_DATA_LOADER_FILE_PATH = "data_loaders/femnist/test_data_loader.pickle"

#     # if not os.path.exists("data_loaders/femnist"):
#     #     pathlib.Path("data_loaders/femnist").mkdir(parents=True, exist_ok=True)
